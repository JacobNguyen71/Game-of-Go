...
def is_black_white(color: GO_COLOR) -> bool:
    """
    Returns whether the color is either black or white and not empty or border
    """
    return color == BLACK or color == WHITE

def is_black_white_empty(color: GO_COLOR) -> bool:
    """
    Returns whether the color is either black or white or empty but not border
    """
    return color == BLACK or color == WHITE or color == EMPTY

def opponent(color: GO_COLOR) -> GO_COLOR:
    """
    Returns the current opponents color in an integer
    """
